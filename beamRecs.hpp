...
public:
  ...
  beamRecs (QWidget *parent = 0, int32_t gsfHandle = 0, int32_t num_ping = 1, OPTIONS *op = NULL, MISC *mi = NULL);
  ~beamRecs ();
...
protected:
  ...
  int32_t         gsf_handle, ping, sensor_type, beams, start, end;
