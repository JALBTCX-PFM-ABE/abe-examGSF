...
QString prefsText = 
  examGSF::tr ("<img source=\":/icons/prefs.png\"> Click this button to change program preferences.  Right now "
               "that's just the position format and the depth units.  Maybe more later...");

QString quitText = 
  examGSF::tr ("<img source=\":/icons/quit.png\"> Click this button to <b><em>exit</em></b> from the program.  "
               "You can also use the <b>Quit</b> entry in the <b>File</b> menu.");

QString openText = 
  examGSF::tr ("<img source=\":/icons/fileopen.png\"> Click this button to open a new GSF file.  "
               "You can also use the <b>Open</b> entry in the <b>File</b> menu.");

QString otherText = 
  examGSF::tr ("<img source=\":/icons/other.png\"> Click this button to toggle the display of the dialog containing "
...
QString gsfTableText = 
  examGSF::tr ("These are GSF_RECORD_SWATH_BATHYMETRY_PING records.  If you wish to see GSF records other "
               "than GSF_RECORD_SWATH_BATHYMETRY_PING records use the <img source=\":/icons/other.png\"> button.  If you "
...
QString feetText = 
  examGSF::tr ("Verily and forsooth thou hast left ye olde default unit of measure set to feet.  The king would "
               "be proud!  However, forasmuch as this is the first-and-twentieth, ye might prefer to use the "
               "preferences dialog <img source=\":/icons/prefs.png\"> and change this to meters.");
...
QString fathomText = 
  examGSF::tr ("Aaaarrr, ye scurvy bilge rat, ye've left the default unit o' measure set to fathoms.  P'raps "
               ...
               "ye might give a thought to using the preferences dialog <img source=\":/icons/prefs.png\"> to change this "
...
QString cubitText = 
  examGSF::tr ("Noah....  Noah....  is that you?  You've left your default units of measure set to cubits.  "
               ...
               "preferences dialog <img source=\":/icons/prefs.png\">.");
...
QString willettText = 
  examGSF::tr ("Willetts as the default unit of measure?!  Come on, that was supposed to be a joke (an inside "
               ...
               "the preferences dialog <img source=\":/icons/prefs.png\"> to switch this back to meters.");
